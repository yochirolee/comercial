  ...
  const filteredOfertas = searchLower
    ? ofertas.filter(
        (o) =>
          ...
          (o.fecha && o.fecha.toLowerCase().includes(searchLower)) ||
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="mb-4 sm:mb-6">
          <div className="relative w-full sm:max-w-sm">
            ...
            <Input
              placeholder="Buscar por número, fecha, producto, estado..."
              value={search}
              onChange={(e) => {
              ...
              {loading ? (
                ...
                <TableRow>
                  <TableCell colSpan={5} className="text-center py-8 text-slate-500">
                    {ofertas.length === 0 ? "No hay ofertas generales" : "No hay resultados para la búsqueda"}
                  </TableCell>
                </TableRow>
              ) : (
